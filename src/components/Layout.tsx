...
export function Layout({ children, currentView, onViewChange, onProfileClick }: LayoutProps) {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            >
              ...
              <h1 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">SegmentAI</h1>
            </button>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 overflow-y-auto max-h-[calc(100vh-80px)]">
